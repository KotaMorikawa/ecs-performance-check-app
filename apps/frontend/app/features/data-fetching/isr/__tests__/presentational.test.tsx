...
describe("IsrPresentational", () => {
  ...
  it("should render ISR demo correctly", () => {
    render(<IsrPresentational categories={mockCategories} metrics={mockMetrics} error={null} />);

    // ヘッダーが表示されていることを確認
    expect(screen.getByText("ISR Data Fetching Demo")).toBeInTheDocument();
    expect(
      screen.getByText(/Incremental Static Regeneration with time-based revalidation/)
    ).toBeInTheDocument();
  });
  ...
  it("should handle empty categories", () => {
    render(<IsrPresentational categories={[]} metrics={mockMetrics} error={null} />);
  ...
  it("should handle error state", () => {
    ...
    render(<IsrPresentational categories={[]} metrics={null} error={errorMessage} />);
  ...
  it("should display cache status", () => {
    ...
    render(<IsrPresentational categories={mockCategories} metrics={cachedMetrics} error={null} />);
  ...
  it("should handle stale content correctly", () => {
    ...
    render(<IsrPresentational categories={mockCategories} metrics={staleMetrics} error={null} />);
  ...
  it("should handle metrics without performance data", () => {
    render(<IsrPresentational categories={mockCategories} metrics={null} error={null} />);

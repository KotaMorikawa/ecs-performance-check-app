...
describe("SsrPresentational", () => {
  ...
  it("should render SSR demo correctly", () => {
    render(<SsrPresentational userProfile={mockUserProfile} metrics={mockMetrics} error={null} />);
  ...
  it("should handle null user profile", () => {
    render(<SsrPresentational userProfile={null} metrics={mockMetrics} error={null} />);
  ...
  it("should handle error state", () => {
    ...
    render(<SsrPresentational userProfile={null} metrics={null} error={errorMessage} />);
  ...
  it("should handle anonymous user", () => {
    ...
    render(
      <SsrPresentational userProfile={dataWithAnonymousUser} metrics={mockMetrics} error={null} />
    );
  ...
  it("should display user verification status", () => {
    ...
    render(<SsrPresentational userProfile={unverifiedUser} metrics={mockMetrics} error={null} />);
  ...
  it("should handle missing bio", () => {
    ...
    render(<SsrPresentational userProfile={userWithoutBio} metrics={mockMetrics} error={null} />);
  ...
  it("should handle metrics without performance data", () => {
    render(<SsrPresentational userProfile={mockUserProfile} metrics={null} error={null} />);
  ...
  it("should handle different post counts correctly", () => {
    ...
    render(
      <SsrPresentational userProfile={userWithManyPosts} metrics={mockMetrics} error={null} />
    );
  ...
  it("should handle single post count", () => {
    ...
    render(<SsrPresentational userProfile={userWithOnePost} metrics={mockMetrics} error={null} />);
  ...
  it("should handle zero posts", () => {
    ...
    render(<SsrPresentational userProfile={userWithNoPosts} metrics={mockMetrics} error={null} />);

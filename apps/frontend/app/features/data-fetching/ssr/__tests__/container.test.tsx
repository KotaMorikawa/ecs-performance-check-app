...
describe('SsrContainer', () => {
  ...
  it('should render SSR user profile correctly', async () => {
    ...
    (userProfileApi.getCurrentProfile as MockedFunction<typeof userProfileApi.getCurrentProfile>).mockResolvedValue({
  ...
  it('should handle API errors gracefully', async () => {
    ...
    (userProfileApi.getCurrentProfile as MockedFunction<typeof userProfileApi.getCurrentProfile>).mockRejectedValue(

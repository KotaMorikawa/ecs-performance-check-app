...
import { Menu, Home, Settings, User, FileText } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <Badge variant="secondary" className="ml-3">Layout Layer 2</Badge>
            </div>
            <nav data-testid="shared-navigation" className="flex space-x-4">
              <a href="#" className="flex items-center text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <Card data-testid="sidebar-content">
              ...
              <CardContent>
                <nav className="space-y-2">
                  ...
                  <a href="#" className="block px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100 bg-blue-50 text-blue-700">
                    Nested Layout
                  </a>
                  <a href="#" className="block px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100">
                    Dynamic Routes
          ...
          <main className="lg:col-span-3">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <div className="mb-4">
                <Badge variant="outline" className="mb-2">Nested Layout Content</Badge>

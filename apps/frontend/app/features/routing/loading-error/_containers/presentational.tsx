  ...
  return (
    <div className="min-h-screen bg-white p-8">
      <header className="mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Loading & Error Handling</h1>
              ...
              <div className="border-t pt-4">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
                  <p className="text-sm text-blue-700">
                    <strong>loading.tsx</strong> - このディレクトリには loading.tsx
                    ファイルが配置されており、
              ...
              <div className="border-t pt-4">
                ...
                <div className="bg-red-50 border border-red-200 rounded-md p-4">
                  <p className="text-sm text-red-700">
                    <strong>error.tsx</strong> - このディレクトリには error.tsx
                    ファイルが配置されており、
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-gray-600">
                  React Stateを使用して、コンポーネント内で ローディング・エラー状態を詳細に制御
                </p>
              </div>
            </div>
          </CardContent>

...
const mockHealthEvaluation = {
  ...
  layers: {
    ...
    'full-route-cache': { status: 'healthy' as const, issues: [], lastCheck: '2023-01-01T00:00:00Z' },
    'router-cache': { status: 'healthy' as const, issues: [], lastCheck: '2023-01-01T00:00:00Z' },
    'request-memoization': { status: 'healthy' as const, issues: [], lastCheck: '2023-01-01T00:00:00Z' },
    'cloudfront-cache': { status: 'healthy' as const, issues: [], lastCheck: '2023-01-01T00:00:00Z' },
  },
  alerts: [],
  uptime: 99.9,
};
...
describe('CacheComparisonPresentational', () => {
  const defaultProps = {
    ...
    overallMetrics: {
      layers: {
        'data-cache': { strategy: 'data-cache' as const, hits: 50, misses: 10, totalRequests: 60, hitRate: 83.3, avgResponseTime: 25, cacheSize: 4096 },
        'full-route-cache': { strategy: 'full-route-cache' as const, hits: 50, misses: 10, totalRequests: 60, hitRate: 83.3, avgResponseTime: 15, cacheSize: 4096 },

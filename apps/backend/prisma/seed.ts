  ...
  const posts = [
    {
      ...
      content:
        "Next.js 15.3.4で追加された新機能について詳しく解説します。App Router、Server Actions、Suspense等の新機能により、より効率的なアプリケーション開発が可能になりました。",
    ...
    },
    {
      ...
      content:
        "AWS ECS環境でのNext.jsアプリケーションのパフォーマンス最適化について実践的な手法を紹介します。",
    ...
    },
    {
      ...
      content:
        "Core Web Vitalsの各指標（LCP、FID、CLS、INP）の測定方法と改善手法について解説します。",
    ...
    },
    {
      ...
      content:
        "Prismaを活用したスキーマ設計とマイグレーション、シードデータの管理について説明します。",
